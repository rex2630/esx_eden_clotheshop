local hasAlreadyEnteredMarker, hasPaid, hasLoadCloth, currentActionData = false, false, false, {}
	...
	TriggerEvent('esx_skin:openRestrictedMenu', function(data, menu)
		...
		ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'shop_confirm', {
			...
			if data.current.value == 'yes' then
				ESX.TriggerServerCallback('esx_eden_clotheshop:buyClothes', function(bought)
					if bought then
